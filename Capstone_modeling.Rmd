...
The way our group approached the modeling phase of this project was to first revisit our business understanding and the problem we were trying to solve. The business question we sought to answer was: "What behavioral patterns lead to cart abandonment on MyCoke360, and how can we predict and prevent it?". I assisted in the development of our logistic regression models and ensured the correct implementation of our feature engineering steps. I also contributed by combining our modeling results and insights into a cohesive narrative for this notebook.
