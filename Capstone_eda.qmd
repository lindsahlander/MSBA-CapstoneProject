...
Our group worked closely together to pull together our EDA. It required a lot of data wrangling and ensuring that our joins were accurate. We divided up the analysis on the joined data set so that each member could focus on a specific area of interest. I focused on analyzing correlation analysis and a baseline logistic regression model to inform future modeling efforts. In this report, I will include our shared introduction, purpose of analysis, data overview, data preparation, missing data, imputation, outliers, and finally my independent variable analysis. The rest of the EDA sections were completed by other group members and can be found in their respective reports.
